// Safegrid verify + admin + download in one module (Vercel serverless)
// Routes:
...
const GH_REPO = process.env.GH_DATA_REPO || 'safegrid-data';
const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || '';
const PEPPER = process.env.ACCESS_PEPPER || 'safegrid-pepper-xj6essw0';

const FILES = [
  '01-agent-guardrail-system.pdf',
  '02-scope-card-worksheet.pdf',
  '03-least-privilege-credential-kit.pdf',
  '04-blast-radius-blueprint.pdf',
  '05-two-key-reversibility-gate.pdf',
  '06-decision-ledger-governance.pdf',
  '07-incident-response-playbook.pdf',
  '08-30-day-hardening-playbook.pdf',
];
